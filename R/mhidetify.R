...
mhidetify <- function(x, y, number_subset, size_subset, asymvec, ep=0.1, alpha_swamp, alpha_mask, alpha_validate)
{
  ...
  clean_set <- ease_masking(x,y, xquant, yquant, inv_rob_sdx, rob_sdy, number_subset,size_subset,est_clean_set,asymvec,df,alpha_mask)$clean_set
  ...
  inf_setfinal <- vhidetify(x, y, xquant, yquant, inv_rob_sdx, rob_sdy, asymvec, inf_set, non_inf_set, df, alpha_validate)$inf_setfinal
